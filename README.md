...
* Pipenv [Install](https://pipenv.pypa.io/en/latest/)
...
* Customer Accounts: Users can create accounts to manage their information and order history.
* Review System: Users can leave reviews for products.

## Api Documentation
* Product API: /api/products/
* Collection API: /api/collections/
* Cart API: /api/cart/
